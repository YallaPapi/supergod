...
**Dependency graph validation** — Before execution starts, subtask dependencies are checked for missing references, self-dependencies, duplicate IDs, and circular chains. Invalid plans fail fast instead of deadlocking workers.
