...
**Dependency graph validation** — Before scheduling starts, decomposition output is validated for duplicate IDs, missing dependency references, and circular dependency chains. Invalid plans fail fast instead of getting stuck with unassignable subtasks.
