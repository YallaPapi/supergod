...
**Dependency graph validation** — Before assignment starts, the orchestrator validates the subtask DAG for circular and missing dependency references, then blocks invalid subtasks with explicit error categories.
