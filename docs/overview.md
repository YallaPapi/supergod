...
**Output validation** — Before accepting a worker completion, the orchestrator verifies the branch exists on remote, the reported commit matches branch head, and the branch differs from `main`.
