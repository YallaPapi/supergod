...
**Dependency graph validation** — Decomposed subtasks are checked before execution to reject unknown/self/circular dependencies. Invalid plans fail fast instead of hanging with unassignable work.
