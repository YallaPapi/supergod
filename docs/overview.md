...
**Dependency graph validation** — Subtask plans are validated before execution. Missing dependencies or circular dependency chains are rejected early instead of silently deadlocking the scheduler.
