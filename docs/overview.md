...
**Dependency graph validation** — Before dispatching work, the orchestrator validates subtask dependencies (duplicate IDs, missing dependencies, circular chains) and fails fast on invalid plans.
