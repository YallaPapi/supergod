...
**Dependency graph validation** — Decomposed plans are validated before assignment. Unknown dependencies and circular dependency graphs are rejected immediately to avoid deadlocked tasks.
